...
class ActiveLearningLoop:
    ...
    def step(self, pool=None) -> bool:
        ...
        if len(pool) > 0:
            ...
            elif isinstance(self.heuristic, heuristics.Oracle):
                labelled_g, unlabelled_g = self.dataset.group_array
            ...
            if probs is not None and (isinstance(probs, types.GeneratorType) or len(probs) > 0):
                ...
                elif isinstance(self.heuristic, heuristics.CombineHeuristics):
                    to_label, uncertainty = self.heuristic.get_ranks([probs] * len(self.heuristic.composed_heuristic))
                else:
                ...
                if self.uncertainty_folder is not None:
                    ...
                    pickle.dump(
                        ...
                        (f := open(pjoin(self.uncertainty_folder, uncertainty_name), "wb")),
                    )
                    f.close()
