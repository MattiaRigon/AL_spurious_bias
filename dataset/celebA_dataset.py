...
class CelebADataset(WILDSDataset):
    ...
    def __init__(self, version=None, root_dir='data', download=False, split_scheme='official', target_name='Blond_Hair'):
        ...
        self._metadata_map = {
            'y': [f'not {target_name.lower()}', f'    {target_name.lower()}'] # Padding for str formatting
        }
